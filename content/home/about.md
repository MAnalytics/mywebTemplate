...
Check-out my [GitHub page](https://github.com/MAnalytics) for some useful crime analytical tools and [here](https://github.com/MAnalytics/Webdesign_using_Hugo_blogdown) for 'step-by-step' of how I designed this website using [Hugo](https://gohugo.io/) and [R-blogdown](https://bookdown.org/yihui/blogdown/).
